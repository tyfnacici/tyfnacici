---
title: "Neden 2025 yılında Windows yerine Linux kullanmalısın?"
description: "Linux ve Windows işletim sistemlerinin karşılaştırması, neden Linux tercih edilmeli?"
draft: false
tags: ["Linux", "Windows", "Comparison"]
showToc: true
weight: 90
cover:
    image: "blog/linux-vs-windows/cover.png"
---
...
Öncelikle şunu belirtmek istiyorum. **Linux** bir işletim sistemi değil kerneldir. Halk arasında **Linux** denilen işletim sistemi aslında **GNU/Linux**tur. Bu yazıda da hedef kitleye hitaben ben de **GNU/Linux** yerine **Linuxu** kullanacağım.
...
<img src="https://cdn-images-1.medium.com/max/1024/1*HcS0Vw1rA2DkmaqdusgpnQ.png" alt="Image" />
*Linux maskotu Tux. Evet, O bir penguen.*
...
1984 yılında Richard Stallman GNU projesini başlattı ve ücretsiz UNIX benzeri bir işletim sistemi oluşturmak istedi. 1991 yılına gelindiğinde ise GNU projesinde UNIX işletim sistemindeki bir çok program açık kaynaklı bir hale getirilmişti fakat bu programların donanımla etkileşime geçebilmek için bir kernele ihtiyacı vardı. ([**GNU proje sayfası**](https://www.gnu.org/gnu/gnu.html))

<img src="https://cdn-images-1.medium.com/max/1024/1*eAjNrVieWpXZCjzrKrrqpg.png" alt="Image" />
*Linux kerneli hakkında basit bir diyagram.*


Tesadüfe bakın şimdi ^^. 1991 yılında Helsinki Üniversitesinde Bilgisayar Bilimleri okuyan Linus Torvals bir kernel yazıyordu. İleride bu kernelin adı **Linux **olacaktı. Linus, bu kerneli özellikle kendi kullandığı donanıma özel ve bir işletim sisteminden bağımsız olacak şekilde yazdı. ([Vikipedi](https://en.wikipedia.org/wiki/Linux))

<img src="https://cdn-images-1.medium.com/max/504/1*hcpbuNRgSeIQ39Gna-ywTQ.png" alt="Image" />
*Linus Torvalds’ın Linux kernelini duyurduğu ilk yazı.*
...
**Linux**da her distronun kendine ait bir paket yöneticisi bulunur. Programları indirme işlemi veya güncelleme işlemini buradan yaptığınız için her programı ayrı ayrı konumlardan güncellemeniz gerekmez. Hepsini tek bir konumdan kolaylıkla yapabilirsiniz.
...
Açık kaynaklı olduğundan dolayı **Linux**da sınır hayal gücünüzdür. Aşağıya size ilham verebilmek için kendim özelleştirdiğim masaüstümü ve bir videoyu bırakıyorum. :)
...
**Linux**da “Shell Scripting” ile (Kabuk Programlama) bir çok şeyi otomatize edebilirsiniz.


Son olarak ise **Linux**a karşı beni gördüğüm bir ön yargı var. Onları da yıkmak isterim.
...
Ek olarak konunun biraz da felsefe kısmını da araştırmanızı öneririm. (bkz: [Link](https://www.gnu.org/philosophy/free-sw.html))
...
<iframe src="https://cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fwww.youtube.com%2Fembed%2F3Qec7Gj4DcQ%3Ffeature%3Doembed&display_name=YouTube&url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D3Qec7Gj4DcQ&image=https%3A%2F%2Fi.ytimg.com%2Fvi%2F3Qec7Gj4DcQ%2Fhqdefault.jpg&key=a19fcc184b9711e1b4764040d3dc5c07&type=text%2Fhtml&schema=youtube" width="854" height="480" frameborder="0" scrolling="no">[https://medium.com/media/42b2f2697651b8a1992192950787769c/href](https://medium.com/media/42b2f2697651b8a1992192950787769c/href)</iframe>

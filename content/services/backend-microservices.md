---
title: "Java Spring Boot Microservices & Backend Development"
description: "Scalable backend systems with Java Spring Boot microservices, distributed architecture, API gateways, and event-driven communication"
draft: false
tags: ["Java", "Spring Boot", "Microservices", "Distributed Systems", "API Gateway", "REST API", "Event-Driven"]
showToc: true
weight: 25
---
...
**Frameworks:** Spring Boot, Spring Cloud, NestJS
**Patterns:** Eureka, API Gateway, Circuit Breaker (Resilience4j), distributed tracing
**Messaging:** SQS, RabbitMQ, EventBridge
**Databases:** PostgreSQL, MSSQL, DynamoDB, MySQL

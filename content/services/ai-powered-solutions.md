---
title: "AI Integration & Automation (LLM, RAG, Agents)"
description: "Custom AI workflows — LLM integrations, RAG pipelines, multi-agent orchestration, and business process automation that works in production"
draft: false
tags: ["AI", "LLM", "RAG", "Automation", "Agentic Systems", "Claude", "OpenAI", "MCP"]
showToc: true
weight: 30
---
...
**LLMs:** Claude API, OpenAI API, Gemini, open-source models (Llama, Mistral, Qwen)
**Frameworks:** LangChain, custom agent orchestration
**Data:** RAG pipelines, vector databases (Pinecone, Qdrant), structured SQL
